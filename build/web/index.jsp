        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                ...
                <ul id="navul" class="nav navbar-nav">
                    ...
                    <li class="dropdown"><a class="dropbtn lili" href="">Product<span class="caret"></span></a>
                        <div class="dropdown-content">
                            <a href="Wood">Wood Awards</a>
                            <a href="Glass">Glass Plaques</a>
                            <a href="Golf">Golf Trophies</a>
                        </div>
                    </li>
