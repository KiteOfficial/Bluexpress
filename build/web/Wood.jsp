        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div id="Container">
                ...
                <div id="wood<%=rs.getString("ID")%>" class="product">
                    <a href="" data-toggle="modal" data-target="#myModal<%=rs.getString("ID")%>"><img class="targetprod" src="Images/products/<%=rs.getString(2)%>.jpg"/><p class="click"> Click to View Details</p><span class="prodtitle"><%=rs.getString("productname")%></span></a>
