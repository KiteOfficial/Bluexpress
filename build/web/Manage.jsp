            ...
            <div id="Container2">
                <div id="navigator2">
                    <ul>
                        ...
                        <li><a href="AddProduct" target="_self">AddProduct</a></li>
                    ...
                    <div id="wrapper">
                        <table id="viewprod" class="table table-hover" align="center">
                            ...
                            <tr>
                                ...
                                <td> <%=itr.next()%></td>
                                <td> <%=itr.next()%></td>
                                <td> <input class="btn btn-primary btn-block" type="submit" value="Edit" name="Edit" onclick="editRecord(<%=s%>);"/></td><!-- UpdateData.java -->
