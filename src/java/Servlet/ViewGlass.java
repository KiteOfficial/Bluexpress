...
public class ViewGlass extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      ps = (PreparedStatement) con.prepareStatement("Select * from product where type = 'glass'");
      rs = ps.executeQuery();
      while (rs.next()) {
      ...
      try {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/ViewGlass.jsp");
