    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
                ...
                <ul id="navul" class="nav navbar-nav">
                    ...
                    <li class="dropdown" class="active"><a class="lili dropdown-toggle" data-toggle="dropdown" href="#product">Product<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active" style="cursor: default;"><a href="Golf.jsp">Golf Trophies</a></li>
                        </ul>
                    </li>
            ...
            <div id="Container">
                ...
                <div id="banner">
                    <h1> <center> Golf Trophies Product </center> </h1>
                </div>    
                <div id="search">
                ...
                <%
                    ...
                    try {
                        ...
                        try {
                            ...
                            ps = (PreparedStatement) con.prepareStatement("Select * from product where type = 'golf' and stack > 29");
                            rs = ps.executeQuery();
                            while (rs.next()) {%>

                <div id="golf<%=rs.getString("ID")%>" class="product">
